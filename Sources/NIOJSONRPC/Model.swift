...
extension NIOJSONRPC {
    ...
    public typealias RPCResult = Result<RPCObject, RPCError>
}

internal extension NIOJSONRPC.JSONObject {
            ...
            do {
                ...
                do {
                    ...
                    do {
                        ...
                        do {
                            let value = try container.decode([NIOJSONRPC.JSONObject].self)
                            self = .list(value)
                        } catch {
                            do {
                                let value = try container.decode([String: NIOJSONRPC.JSONObject].self)
